 ...
 * Original file: /gh/kothinti/ik@master/ep-webinar-us.v4.js
 *
...
$(document).ready((function () {
  ...
  function a(e) {
    ...
    for (i = 0; i < o; i++) {
      ...
      time = e[i].invitee_start_time.split("-")[0].trim().slice(0, -2) + ' - ' + e[i].invitee_end_time.split("-")[0].trim();
      var d = e[i].weekday + ", " + e[i].day + " " + a[parseInt(e[i].month) - 1] + " " + e[i].year + " | " + e[i].hour + ":" + e[i].minute + " " + e[i].am_or_pm,
        m = '<div class="calender-webinar-slot-box"><div class="webinar_timer_date-time"><div class="webinar_timer_day">' + e[i].weekday + '</div><div class="webinar_timer_time">' + e[i].day + '</div></div><label class="webinar-timer-slot-block w-radio" data-weekday="' + e[i].weekday + '" data-date="' + e[i].day + '" data-time="' + time + '" ><div class="w-form-formradioinput w-form-formradioinput--inputType-custom radio_button webinar-timer-slot w-radio-input"></div > <input type="radio" id="' + e[i].start_time + '" data-endtime="' + e[i].end_time + '" name="time-slot" value="' + e[i].start_time + '" data-name="time slot" style="opacity:0;position:absolute;z-index:-1"><span for="' + e[i].start_time + '" class="webinar-timer-text w-form-label">' + time + '</span><div class="webinar-available-slot">Available Slots - 23</div><div class="radio-button-checked-div"><img src="https://assets-global.website-files.com/5d0cef7a72ca1b074065dfda/6530d9514b79e8487a5c9c77_check%20(2)%201.png" loading="lazy" alt="" class="radio-button-checked-icon"></div></label></div > ',
  ...
  $(document).on('click', '.webinar-timer-slot-block', function (e) {
    $(".select-time-slot-div>.select-slot-date").empty();
    $(".select-time-slot-div>.select-slot-time").empty();
    $(".select-time-slot-div>.select-slot-date").append(`${$(this).attr("data-weekday")} <br> ${$(this).attr("data-date")}`);
    $(".select-time-slot-div>.select-slot-time").append(`${$(this).attr("data-time")}`);
    // alert($(this).attr("data-time") + ' - ' + $(this).attr("data-date") + ' - ' + $(this).attr("data-weekday"));
  });
